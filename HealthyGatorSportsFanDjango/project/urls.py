...
from app.views import index, CreateUserView, poll_cfbd_view, BasicInfoView, GoalCollectionView, CreateUserDataView, NotificationList, NotificationDetail, BulkDeleteNotifications, UserLoginView, LatestUserDataView, UserUpdateView, CheckEmailView
...
urlpatterns = [
    ...
    path('api/users/<int:user_id>/', UserUpdateView.as_view(), name='update_user'),
