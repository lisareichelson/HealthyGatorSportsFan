...
from HealthyGatorSportsFanDjango.app.views import index, CreateUserView, poll_cfbd_view, home_tile_view, CreateUserDataView, NotificationListView, CreateNotificationView, DeleteNotificationView, BulkDeleteNotificationsView, UserLoginView, LatestUserDataView, UserUpdateView, CheckEmailView
# for running locally
